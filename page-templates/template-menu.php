...
$menu_sections = array(
	array(
		...
		'brand'    => 'tf-bites',
		'items'    => array(
			array( 'Spicy Chicken Sandwich', '12.99' ),
			array( 'Classic Chicken Bun', '9.99' ),
			array( 'Cheese Ravioli Marinara', '12.99' ),
			array( 'Penne Pasta Alfredo', '10.99' ),
			array( 'Chicken Parmesan', '14.99' ),
		),
	),
	array(
		'title'    => 'Sides',
	...
	array(
		...
		'accent'   => true,
		'items'    => array(
			array( 'Carrot Cake Bar', '6.99' ),
			array( 'Lemon Bar', '7.99' ),
			array( 'Waffle (Sugar or Nutella)', '5.99' ),
			array( 'Cheesecake Slice', '6.99' ),
	...
	array(
		...
		'items'    => array(
			...
			array( 'Refreshers', '6.49 | 7.99' ),
			array( 'Matcha', '6.99 | 8.49' ),
		),
	),
	array(
		'title'    => 'Coffee &amp; Chai',
	...
	array(
		...
		'accent'   => true,
		'items'    => array(
			array( 'Frozen Yogurt', '6.99 | 12.49', 'with your choice of toppings' ),
	...
	array(
		...
		'accent'   => true,
		'items'    => array(
			array( 'Build Your Own Bowl', '10.49', 'with your favorite toppings' ),
		),
	),
);
